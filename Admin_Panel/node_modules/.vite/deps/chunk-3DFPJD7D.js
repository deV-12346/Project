...
var LayoutContext = React33.createContext({
  siderHook: {
    addSider: () => null,
    removeSider: () => null
  }
...
var SiderContext = React34.createContext({});
...
var Sider = React34.forwardRef((props, ref) => {
  const {
  ...
  const {
    siderHook
  } = (0, import_react16.useContext)(LayoutContext);
  const [collapsed, setCollapsed] = (0, import_react16.useState)("collapsed" in props ? props.collapsed : defaultCollapsed);
  const [below, setBelow] = (0, import_react16.useState)(false);
  ...
  const responsiveHandlerRef = (0, import_react16.useRef)(null);
  ...
  const zeroWidthTrigger = parseFloat(String(collapsedWidth || 0)) === 0 ? React34.createElement("span", {
    onClick: toggle,
  ...
  }, trigger || React34.createElement(BarsOutlined_default, null)) : null;
  const reverseIcon = direction === "rtl" === !reverseArrow;
  const iconObj = {
    expanded: reverseIcon ? React34.createElement(RightOutlined_default, null) : React34.createElement(LeftOutlined_default, null),
    collapsed: reverseIcon ? React34.createElement(LeftOutlined_default, null) : React34.createElement(RightOutlined_default, null)
  };
  const status = collapsed ? "collapsed" : "expanded";
  const defaultTrigger = iconObj[status];
  const triggerDom = trigger !== null ? zeroWidthTrigger || React34.createElement("div", {
  ...
  return wrapCSSVar(React34.createElement(SiderContext.Provider, {
    value: contextValue
  }, React34.createElement("aside", Object.assign({
    className: siderCls
  }, divProps, {
    style: divStyle,
    ref
...
//# sourceMappingURL=chunk-3DFPJD7D.js.map
